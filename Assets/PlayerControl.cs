...
public class PlayerControl : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // jika tombol ke atas ditekan, beri kecepatan positif ke komponen y (ke atas)
        if (Input.GetKey(upButton))
        {
            velocity.y = speed;
        }

        // jika tombol ke bawah ditekan, beri kecepatan negatif ke komponen y (ke bawah)
    ...
    // Untuk mengkakses informasi titik kontak dari kelas lain
